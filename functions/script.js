...
function idCard(x, y, z){
    ...
    // aaj bhi ni ho Paya, coz mamu ke riste ko leke bahut excited the and sb gya tha dekhne aaj, we are ok from our side, just we nee verification from their side, baaki sunday wo log ke aane ka pln hua hai , if everything goes well, to final smjo, baki bye good night kal se krunga continue.
}
...
function sayHi(){
   ...
   kush smj ni aara hai, kya kru, kaise kru, pata ni kya hua, kya hora hai, I hope god muje rasta dikjaynge, bye good night
    aaj ni hua padhai, aaj resume banaye, consultancy wle ko diye hai, lets see kya hota hai, baki kal krunga phir se pdhai, upr se weight bhi badh rha hai, uska bhi thoda dhiyan rakhna padega ab 
