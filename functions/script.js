...
function idCard(x, y, z){
    ...
    // aaj bhi ni ho Paya, coz mamu ke riste ko leke bahut excited the and sb gya tha dekhne aaj, we are ok from our side, just we nee verification from their side
}
